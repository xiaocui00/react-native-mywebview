...
public class WebViewActivity extends AppCompatActivity implements BaseTitleBar.onRightTextViewClickListener, BaseTitleBar.onRightImageViewClickListener, BaseTitleBar.onLeftFinishClickListener, BaseTitleBar.onLeftBackClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            window.setNavigationBarColor(this.getResources().getColor(R.color.trans_black));
        ...
        coreWebView.setWebChromeClient(
                new InjectedChromeClient("ruitaiApp", AndroidJS.class)
        );

//        coreWebView.loadUrl("file:////android_asset/index.html");
    ...
    public static class AndroidJS {
        ...
        public static void setRightTitle(WebView webView, JSONObject msg) {
            ...
            try {
                WebViewActivity.webViewActivity.RightMsg = msg;
                if (msg != null && msg.getString("showRightTitle") != null && msg.getString("showRightTitle").length() > 0) {
                    ...
                    if ("0".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setRightView("", 0);
                    } else if ("1".equals(showRightTitle)) {
                        if (msg.getString("rightTitle") != null) {
                            WebViewActivity.webViewActivity.titleBar.setRightView(msg.getString("rightTitle"), 1);
                        }
                    } else if ("2".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setRightView("", 2);
                    }
                }
            } catch (JSONException e) {
                e.printStackTrace();
        ...
        public static void setLeftTitle(WebView webView, JSONObject msg) {
            ...
            try {
                WebViewActivity.webViewActivity.leftMsg = msg;
                if (msg != null && msg.getString("showLeftTitle") != null) {
                    String showRightTitle = msg.getString("showLeftTitle");
                    if ("0".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setLeftView(0);
                    } else if ("1".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setLeftView(1);
                    } else if ("2".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setLeftView(2);
                    } else if ("3".equals(showRightTitle)) {
                        WebViewActivity.webViewActivity.titleBar.setLeftView(3);
                    }
                }
            } catch (JSONException e) {
                e.printStackTrace();
...
//            }
            ...
            WebViewActivity.webViewActivity.titleBar.setTitle(msg, 0);
    ...
    private void initShareDialog() {
        ...
        dialogBinding.findViewById(R.id.ll_share_friend).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dialogBinding.findViewById(R.id.conss).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (dialog != null) {
                    dialog.dismiss();
            ...
            if (msg1.what == 500) {
                ...
                try {
                    if (RightMsg != null && RightMsg.getString("title") != null && RightMsg.getString("desc") != null && RightMsg.getString("link") != null) {
                        ...
                        boolean b = instance.shareUrl(RightMsg.getString("link"), RightMsg.getString("title"), bitmap, RightMsg.getString("desc"), msg1.getData().getInt("scene"));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
